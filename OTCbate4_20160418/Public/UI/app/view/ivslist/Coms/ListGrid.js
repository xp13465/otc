...
Ext.define('ui.view.ivslist.Coms.ListGrid',{
    extend: 'ui.extend.base.Panel',
    alias: 'widget.claimslistpagecentergrid',
    requires :[
        'ui.extend.base.Grid',
    ...
    constructor : function(cfg){
        ...
        this.ctrl = cfg.ctrl;
//定义数据源store
        var url = this.ctrl.$getConfig('urls').get('get.ivslist.list').url;
        this.store = Ext.create( 'ui.store.claimslistStore' , {
            fields : [],
            ctrl : this.ctrl,
            autoLoad: { params: {} },
            proxy : Ext.create( 'ui.extend.base.Ajax',{
                url : url ,    //"/Public/jsons/get.all.ivslist.record.json",
...
//定义字段列表
        ...
        cmconfig = cmconfig || [];
        cmconfig.push({
            header: 'POS扫描件', width: 200, dataIndex: 'oprations',
...
//定义gridpanel
        this.grid = Ext.create('ui.extend.base.Grid',{
            myid : 'ListGrid',
            alias: ["widget.claimslistlistgrid"],
            selModel: sm,
            tbar : this.form,
            border : 0,
            store: this.store,
