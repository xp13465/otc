...
Ext.define('ui.view.claimslist.Coms.ListGrid',{
    ...
    constructor : function(cfg){
        ...
        this.ctrl = cfg.ctrl;
//定义数据源store
        var url = this.ctrl.$getConfig('urls').get('get.claimslist.list').url;
        this.store = Ext.create( 'ui.store.claimslistStore' , {
            fields : [],
            ctrl : this.ctrl,
            autoLoad: { params: {} },
            proxy : Ext.create( 'ui.extend.base.Ajax',{
                url : url ,    //"/Public/jsons/get.all.claimslist.record.json",
