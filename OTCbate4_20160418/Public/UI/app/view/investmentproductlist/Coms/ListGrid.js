...
Ext.define('ui.view.investmentproductlist.Coms.ListGrid',{
    extend: 'ui.extend.base.Panel',
    alias: 'widget.investmentproductlistpagecentergrid',
    requires :[
        'ui.extend.base.Grid',
    ...
    constructor : function(cfg){
        ...
        this.ctrl = cfg.ctrl;
//定义数据源store
        var url = this.ctrl.$getConfig('urls').get('get.investmentproductlist.list').url;
        this.store = Ext.create( 'ui.store.investmentproductlistStore' , {
            fields : [],
            ctrl : this.ctrl,
            autoLoad: { params: {} },
            proxy : Ext.create( 'ui.extend.base.Ajax',{
                url : url ,    //"/Public/jsons/get.all.investmentproductlist.record.json",
...
//定义字段列表
        ...
        cmconfig = cmconfig || [];
        cmconfig.push({
            header: '操作', width: 100, dataIndex: 'oprations',
...
//定义gridpanel
        this.grid = Ext.create('ui.extend.base.Grid',{
            myid : 'ListGrid',
            alias: ["widget.investmentproductlistlistgrid"],
            selModel: sm,
            tbar : this.form,
            border : 0,
            store: this.store,
