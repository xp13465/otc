...
Ext.define('ui.view.assetpackagelist.Coms.ListGrid',{
    extend: 'ui.extend.base.Panel',
    alias: 'widget.assetpackagelistpagecentergrid',
    requires :[
        'ui.extend.base.Grid',
    ...
    constructor : function(cfg){
        ...
        this.ctrl = cfg.ctrl;
//定义数据源store
        var url = this.ctrl.$getConfig('urls').get('get.assetpackagelist.list').url;
        this.store = Ext.create( 'ui.store.assetpackagelistStore' , {
            fields : [],
            ctrl : this.ctrl,
            autoLoad: { params: {} },
            proxy : Ext.create( 'ui.extend.base.Ajax',{
                url : url ,    //"/Public/jsons/get.all.assetpackagelist.record.json",
...
//定义gridpanel
        this.grid = Ext.create('ui.extend.base.Grid',{
            myid : 'ListGrid',
            alias: ["widget.assetpackagelistlistgrid"],
            selModel: sm,
            tbar : this.form,
            border : 0,
            store: this.store,
