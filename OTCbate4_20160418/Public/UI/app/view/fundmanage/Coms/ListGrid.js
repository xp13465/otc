...
Ext.define('ui.view.fundmanage.Coms.ListGrid',{
    ...
    constructor : function(cfg){
        ...
        this.ctrl = cfg.ctrl;
//定义数据源store
        var url = this.ctrl.$getConfig('urls').get('get.fundmanage.list').url;
        this.store = Ext.create( 'Ext.data.Store' , {
            fields : [],
            ctrl : this.ctrl,
            autoLoad: { params: {} },
            proxy : Ext.create( 'ui.extend.base.Ajax',{
                url : url ,    //"/Public/jsons/get.all.fundmanage.record.json",
