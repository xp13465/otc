...
Ext.define('ui.view.investmentproducts.Coms.ListGrid',{
    extend: 'ui.extend.base.Panel',
    alias: 'widget.investmentproductspagecentergrid',
    requires :[
        'ui.extend.base.Grid',
    ...
    constructor : function(cfg){
        ...
        this.ctrl = cfg.ctrl;
//定义数据源store
        var url = this.ctrl.$getConfig('urls').get('get.investmentproducts.list').url;
        this.store = Ext.create( 'ui.store.investmentproductsStore' , {
            fields : [],
            ctrl : this.ctrl,
            autoLoad: { params: {} },
            proxy : Ext.create( 'ui.extend.base.Ajax',{
                url : url     //"/Public/jsons/get.all.investmentproducts.record.json",
            })
        });
//定义checkboxModel
...
//定义字段列表
        ...
        cmconfig = cmconfig || [];
        cmconfig.push({
            header: '操作', width: 300, dataIndex: 'oprations',
...
//定义gridpanel
        this.grid = Ext.create('ui.extend.base.Grid',{
            myid : 'ListGrid',
            alias: ["widget.investmentproductslistgrid"],
            selModel: sm,
            tbar : this.form,
            border : 0,
            store: this.store,
