...
Ext.define('ui.ctrl.productauditleader.productauditleaderCtrl', {
    ...
    refs:[
        {ref:'productauditleaderWin' , selector:'productauditleaderwindow'}
    ],
    ...
    //配置功能按钮功能  对应Conf类中定义的operationButtons > pmsCode { text : '新建角色+' , pmsCode : 'productauditleader.add' }
    //‘.’替换为 $  ,方法前加__
    ...
    */
    ...
    __check_list_btn_event : function(cfg ,record){
        if(cfg.pmsCode === 'productleader.pass'){
