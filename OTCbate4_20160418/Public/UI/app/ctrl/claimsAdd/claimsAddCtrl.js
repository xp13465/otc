...
Ext.define('ui.ctrl.claimsAdd.claimsAddCtrl', {
    ...
    */
    ...
    __all_post_after_main_event : function(thepanel) {
        ...
        var labelValue='';
        postdata.cod_card_type==2?labelValue='公司姓名':labelValue='借款人姓名'; 
...
//alert(postdata.capitalid);
    ...
    __view_fieldinit : function(field){
        ...
        //     field.value===2?labelValue='<span style="color:red">*</span>公司姓名':labelValue='<span style="color:red">*</span>客户姓名'; 
        //     Ext.getCmp('claim_borrower').setFieldLabel(labelValue);
        // }
