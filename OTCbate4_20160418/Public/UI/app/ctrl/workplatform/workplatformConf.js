...
Ext.define('ui.ctrl.workplatform.workplatformConf',{
    ...
    _opButtons : [
        { text : '新建+' , pmsCode : 'workplatform.add' , permissionCode : 'product.add' ,recKey : ['id']  , checkpms:1 } ,
        { text : '批量注销-' , pmsCode : 'workplatform.cancel' , permissionCode : 'product.cancel' ,recKey : ['id']  , checkpms:1 }
    ],
    ...
    _lstOpButtons : [
        ...
        { text : '注销' , pmsCode : 'workplatform.cancel'  , permissionCode : 'product.cancel', recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : ''}
    ],
