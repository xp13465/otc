...
Ext.define('ui.ctrl.user.userConf',{
    ...
    _urls : {
        ...
        'set.user.reset' : { url : "User/resetPassword" , 'pmsCode' : 'set.user.resetPassword' , checkpms : 0 }
    },
    _opButtons : [
        { text : '新建+' , pmsCode : 'user.add' ,recKey : ['id']  , checkpms:0,'permissionCode' : "user.add" },
    ...
    _lstOpButtons : [
        ...
        { text : '重置密码' , pmsCode : 'user.reset' , recKey : ['id']/*所需record之关键字列表*/  , checkpms:1 ,iconCls : '','permissionCode' : "user.stop"}
        // { text : '修改密码' , hidden:true,pmsCode : 'user.uppassword' , recKey : ['id']/*所需record之关键字列表*/  , hidden : 1 , checkpms:0 ,iconCls : ''}
