...
class AdminController extends Controller
{
    ...
    public function __construct()
    {
		...
		//基础共同系统模块 "Admin","Index","Access","Common","Message"
		if(!in_array(CONTROLLER_NAME,array("Admin","Index","Access","Common","User","Message","System"))&&!in_array(MODULE_NAME  ."-".CONTROLLER_NAME   ."-".ACTION_NAME,array("Admin-Cfmast-downposfile"))){
			...
			if(A('Guest/Access')->checkPermission($Permission_code)==false){
...
//    }
     ...
     * @return string $msg
     */
    public function noPermissionMsg($msg = ''){
        $msg = '您没有' . $msg . '权限';
        return $msg;
    }
}