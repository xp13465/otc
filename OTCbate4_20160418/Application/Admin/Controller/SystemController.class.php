...
class SystemController extends AdminController {
    ...
    public function getNodeList(){
        ...
        $field = 'n.id,n.pid,n.name,n.module,n.url,n.iconcls,n.group,n.status,n.sort, np.name as p_node_name,n.type';

        if($post['option'] == 1){
            $limit = $data['total'];
            $field = 'n.id,n.pid,n.name,n.module,n.url,n.iconcls,n.group,n.status,n.sort,n.type';
        }
...
//        echo '<hr>';
     ...
     * 指定角色拥有的节点
     */
    public function getRoleNodeList($type="1"){
        $role_id = I('post.role_id');
        if($role_id) {
            $node_list = D('User')->getRoleNodeList($role_id,-1,$type);
