...
class UserModel extends Model
{
     ...
     * @return array $data
     */
    public function getRoleNodeList($role, $pid = -1, $type = 1)
    {
		...
		if ($type > 0) {
             $where['n.type'] = $type; //取管理后端的节点
        }
       

        $where['n.status'] = 1;
        $data = M('AuthRoleNode')->field('DISTINCT r.node_id,n.name,n.pid,n.module,n.iconCls,n.group ,n.url ,n.type'/*superone 加入url字段*/)
