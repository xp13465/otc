...
<body ng-controller="mainCtrl">
	<div class="desktop clearfix">
		...
		<dl>
			<dt class="clearfix">
				<img src="/Public/UI/images/desktop/desk_new_01.png" alt="" class="mar_r5" style="width: 240px;" ng-click="showUserAccount()"  ng-if="node_id_155">
				<img src="/Public/UI/images/desktop/desk_new_02.png" alt="" style="width: 228px;" ng-click="showUserLogin()"  ng-if="node_id_156">
			</dt>
			<dd class="clearfix">
				<img src="/Public/UI/images/desktop/desk_new_05.png" alt="" style="width: 473px;" class="mar_t5" ng-click="showManagePurchaseFn()"  ng-if="node_id_159">
				
			</dd>
		</dl>
		<dl>
			<dd class="mar_cen5 clearfix">
				<img src="/Public/UI/images/desktop/desk_new_03.png" alt="" style="width: 237px;" ng-click="setUserInfolistFn()"  ng-if="node_id_157">
			</dd>
		</dl>
		<dl>
			<dd class="clearfix">
				<img src="/Public/UI/images/desktop/desk_new_04.png" alt="" style="width: 238px;"  ng-click="showManageRightFn()"  ng-if="node_id_158">
			</dd>
			<dt class="clearfix">
